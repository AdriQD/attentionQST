...
1.In the "basis generation" folder, the files with the the different basis and the dual basis used to generate the datasets. Namely, the tensor products of local SIC-POVM, global square-root POVM of dimension d=3,9  and 4 qubits Pauli operators.
